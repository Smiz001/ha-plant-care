...
## Use
1. Settings → Devices & Services → **Add Integration** → **Plant Care** (creates the hub, once).
2. On the Plant Care hub card, **Add plant** — fill name, emoji, watering/feeding intervals, next dates, and optionally a moisture sensor.
...
- one aggregate `calendar.plant_care` across all plants
